...
(function (UT) {
  ...
  const library = [
    { id: 'gen-0-5-10', name: '0° 5 MHz ⌀10 (generic)', maker: 'generic', family: 'straight', angle: 0, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 0, crystalType: 'single', notes: 'v1 default 0° probe' },
    { id: 'gen-45-5-10', name: '45° 5 MHz ⌀10 (generic)', maker: 'generic', family: 'angle', angle: 45, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 12, crystalType: 'single', notes: 'v1 default' },
    { id: 'gen-60-5-10', name: '60° 5 MHz ⌀10 (generic)', maker: 'generic', family: 'angle', angle: 60, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 12, crystalType: 'single', notes: 'v1 default' },
    { id: 'gen-70-5-10', name: '70° 5 MHz ⌀10 (generic)', maker: 'generic', family: 'angle', angle: 70, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 12, crystalType: 'single', notes: 'v1 default' },
    ...
    { id: 'a430s-45', name: 'A430S-SB 45° (5 MHz, ⌀10)', maker: 'Olympus', family: 'angle', angle: 45, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 12, crystalType: 'single', notes: 'Contact angle beam transducer + ABWS wedge' },
    { id: 'a430s-60', name: 'A430S-SB 60° (5 MHz, ⌀10)', maker: 'Olympus', family: 'angle', angle: 60, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 12, crystalType: 'single', notes: 'Contact angle beam transducer + ABWS wedge' },
    { id: 'a430s-70', name: 'A430S-SB 70° (5 MHz, ⌀10)', maker: 'Olympus', family: 'angle', angle: 70, freq: 5, crystal: { a: 10, b: 10, shape: 'round' }, wedgePath: 12, crystalType: 'single', notes: 'Contact angle beam transducer + ABWS wedge' },
  ...
  function derive(probe, specimen) {
    ...
    const nearField = (a * a * freq) / (4 * vel); // mm  = a²/(4λ)  (rectangular: uses the beam-plane size)
  ...
  UT.probe = {
    ...
    __selftest() {
      ...
      if (Math.abs(dm.nearField - (9 * 9 * 2) / (4 * 3.24)) > 0.05) f.push('mwb60-2 near field ' + dm.nearField);
      ...
      if (Math.abs(d60.vRayleigh - 0.92 * 3.24) > 1e-9) f.push('vRayleigh');
      return f;
    },
  };
})(window.UT = window.UT || {});
